<?php
/**
 * Yuma Customizer Custom Controls
 *
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Yuma_Custom_Control extends WP_Customize_Control {
		protected function get_yuma_resource_url() {
			return trailingslashit( get_template_directory_uri() ) . '/inc/customizer/vendor/customizer-custom-controls-master/';
		}
	}
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Yuma_Custom_Section extends WP_Customize_Section {
		protected function get_yuma_resource_url() {
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	 class Yuma_Image_Checkbox_Custom_Control extends Yuma_Custom_Control {
		/**
		...
		public function enqueue() {
			wp_enqueue_style( 'yuma-custom-controls-css', $this->get_yuma_resource_url() . 'css/customizer.css', array(), '1.0', 'all' );
		}
		/**
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	 class Yuma_Text_Radio_Button_Custom_Control extends Yuma_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	...
	/**
	 * Text Radio Button Tab Heading Custom Control
	 *
	 * @author Anthony Hortin <http://maddisondesigns.com>
	 * @license http://www.gnu.org/licenses/gpl-2.0.html
	 * @link https://github.com/maddisondesigns
	 */
	 class Yuma_Text_Radio_Button_Tab_Heading_Custom_Control extends Yuma_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'text_radio_button_tab_heading';
		/**
		 * Enqueue our scripts and styles
		 */
		public function enqueue() {
		...
		?>
			<div class="text_radio_button_control">
				<div class="radio-buttons">
					<?php $i = 1; foreach ( $this->choices as $key => $value ) { ?>
						<label class="radio-button-label tab-heading <?php echo 1 == $i ? 'customizer-tab-active': ''; ?>" data-key="<?php echo esc_attr( $key ); ?>">
							<span><?php echo esc_html( $value ); ?></span>
						</label>
					<?php $i++; } ?>
				</div>
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Yuma_Image_Radio_Button_Custom_Control extends Yuma_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Yuma_Single_Accordion_Custom_Control extends Yuma_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'yuma-custom-controls-js', $this->get_yuma_resource_url() . 'js/customizer.js', array( 'jquery' ), '1.0', true );
			wp_enqueue_style( 'yuma-custom-controls-css', $this->get_yuma_resource_url() . 'css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Yuma_Simple_Notice_Custom_Control extends Yuma_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Yuma_Slider_Custom_Control extends Yuma_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'yuma-custom-controls-js', $this->get_yuma_resource_url() . 'js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
			wp_enqueue_style( 'yuma-custom-controls-css', $this->get_yuma_resource_url() . 'css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Yuma_Toggle_Switch_Custom_control extends Yuma_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Yuma_Sortable_Repeater_Custom_Control extends Yuma_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Yuma_Dropdown_Select2_Custom_Control extends Yuma_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'yuma-select2-js', $this->get_yuma_resource_url() . 'js/select2.full.min.js', array( 'jquery' ), '4.0.13', true );
			wp_enqueue_script( 'yuma-custom-controls-js', $this->get_yuma_resource_url() . 'js/customizer.js', array( 'yuma-select2-js' ), '1.0', true );
			wp_enqueue_style( 'yuma-custom-controls-css', $this->get_yuma_resource_url() . 'css/customizer.css', array(), '1.1', 'all' );
			wp_enqueue_style( 'yuma-select2-css', $this->get_yuma_resource_url() . 'css/select2.min.css', array(), '4.0.13', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Yuma_Dropdown_Posts_Custom_Control extends Yuma_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Yuma_TinyMCE_Custom_control extends Yuma_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function to_json() {
			parent::to_json();
			$this->json['yumatinymcetoolbar1'] = isset( $this->input_attrs['toolbar1'] ) ? esc_attr( $this->input_attrs['toolbar1'] ) : 'bold italic bullist numlist alignleft aligncenter alignright link';
			$this->json['yumatinymcetoolbar2'] = isset( $this->input_attrs['toolbar2'] ) ? esc_attr( $this->input_attrs['toolbar2'] ) : '';
			$this->json['yumamediabuttons'] = isset( $this->input_attrs['mediaButtons'] ) && ( $this->input_attrs['mediaButtons'] === true ) ? true : false;
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Yuma_Google_Font_Select_Custom_Control extends Yuma_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			$this->fontList = $this->yuma_getGoogleFonts( 'all' );
			// Decode the default json font value
			$this->fontValues = json_decode( $this->value() );
			// Find the index of our default font within our list of Google fonts
			$this->fontListIndex = $this->yuma_getFontIndex( $this->fontList,$this->fontValues->font );
		}
		/**
		 * Enqueue our scripts and styles
		 */
		...
		public function to_json() {
			parent::to_json();
			$this->json['yumafontslist'] = $this->fontList;
		}
		/**
		 * Render the control in the customizer
		 */
		public function render_content() {
			...
			if( !empty($this->fontList) ) {
				...
				<div class="google_fonts_select_control">
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight & style for regular text', 'yuma' ) ?></div>
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight for', 'yuma' ) ?> <italic><?php esc_html_e( 'italic text', 'yuma' ) ?></italic></div>
					<div class="weight-style">
					...
					<div class="customize-control-description"><?php esc_html_e( 'Select weight for', 'yuma' ) ?> <strong><?php esc_html_e( 'bold text', 'yuma' ) ?></strong></div>
					<div class="weight-style">
		 ...
		 */
		public function yuma_getFontIndex( $haystack, $needle ) {
		 ...
		 */
		public function yuma_getGoogleFonts( $count = 30 ) {
			// Google Fonts json generated from https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key=YOUR-API-KEY
			$fontFile = $this->get_yuma_resource_url() . 'inc/google-fonts-alphabetical.json';
			if ( $this->fontOrderBy === 'popular' ) {
				$fontFile = $this->get_yuma_resource_url() . 'inc/google-fonts-popularity.json';
			}
	...
	/**
	 * Google Font Select Two Custom Control
	 *
	 * @author Anthony Hortin <http://maddisondesigns.com>
	 * @license http://www.gnu.org/licenses/gpl-2.0.html
	 * @link https://github.com/maddisondesigns
	 */
	class Yuma_Google_Font_Select_Two_Custom_Control extends Yuma_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'google_fonts';
	 ...
	 */
	class Yuma_Customize_Alpha_Color_Control extends Yuma_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'yuma-custom-controls-js', $this->get_yuma_resource_url() . 'js/customizer.js', array( 'jquery', 'wp-color-picker' ), '1.0', true );
			wp_enqueue_style( 'yuma-custom-controls-css', $this->get_yuma_resource_url() . 'css/customizer.css', array( 'wp-color-picker' ), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 */
	class Yuma_Alpha_Color_Control extends Yuma_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue() {
			wp_enqueue_style( 'yuma-custom-controls-css', $this->get_yuma_resource_url() . 'css/customizer.css', array(), '1.0', 'all' );
			wp_enqueue_script( 'wp-color-picker-alpha', $this->get_yuma_resource_url() . 'js/wp-color-picker-alpha-min.js', array( 'wp-color-picker' ), '1.0', true );
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Yuma_Pill_Checkbox_Custom_Control extends Yuma_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'yuma-custom-controls-js', $this->get_yuma_resource_url() . 'js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.1', true );
			wp_enqueue_style( 'yuma-custom-controls-css', $this->get_yuma_resource_url() . 'css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 *
	 */
	class Yuma_Upsell_Section extends Yuma_Custom_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'yuma-upsell';
		/**
		 * The Upsell URL
		 */
		public $url = '';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="yuma_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
	 ...
	 */
	if ( ! function_exists( 'yuma_url_sanitization' ) ) {
		function yuma_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'yuma_switch_sanitization' ) ) {
		function yuma_switch_sanitization( $input ) {
			if ( true === $input ) {
				return 1;
			} else {
				return 0;
	 ...
	 * @return integer	Sanitized value
	 */
	if ( ! function_exists( 'yuma_radio_sanitization' ) ) {
		function yuma_radio_sanitization( $input, $setting ) {
	 ...
	 */
	if ( ! function_exists( 'yuma_sanitize_integer' ) ) {
		function yuma_sanitize_integer( $input ) {
			return (int) $input;
		}
	}
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'yuma_text_sanitization' ) ) {
		function yuma_text_sanitization( $input ) {
			if ( strpos( $input, ',' ) !== false) {
				$input = explode( ',', $input );
			}
			if( is_array( $input ) ) {
	 ...
	 */
	if ( ! function_exists( 'yuma_array_sanitization' ) ) {
		function yuma_array_sanitization( $input ) {
			if( is_array( $input ) ) {
				foreach ( $input as $key => $value ) {
					$input[$key] = sanitize_text_field( $value );
				}
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'yuma_hex_rgba_sanitization' ) ) {
		function yuma_hex_rgba_sanitization( $input, $setting ) {
			...
			if ( false === strpos( $input, 'rgb' ) ) {
				...
				if ( false === strpos( $input, 'rgba' ) ) {
					...
					$input = 'rgb(' . yuma_in_range( $red, 0, 255 ) . ',' . yuma_in_range( $green, 0, 255 ) . ',' . yuma_in_range( $blue, 0, 255 ) . ')';
				}
				else {
					// Sanitize as RGBa color
					$input = str_replace( ' ', '', $input );
					sscanf( $input, 'rgba(%d,%d,%d,%f)', $red, $green, $blue, $alpha );
					$input = 'rgba(' . yuma_in_range( $red, 0, 255 ) . ',' . yuma_in_range( $green, 0, 255 ) . ',' . yuma_in_range( $blue, 0, 255 ) . ',' . yuma_in_range( $alpha, 0, 1 ) . ')';
				}
			}
			return $input;
		}
	 ...
	 */
	if ( ! function_exists( 'yuma_in_range' ) ) {
		function yuma_in_range( $input, $min, $max ){
			if ( $input < $min ) {
				$input = $min;
			}
			if ( $input > $max ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'yuma_google_font_sanitization' ) ) {
		function yuma_google_font_sanitization( $input ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'yuma_date_time_sanitization' ) ) {
		function yuma_date_time_sanitization( $input, $setting ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'yuma_range_sanitization' ) ) {
		function yuma_range_sanitization( $input, $setting ) {
			...
			return yuma_in_range( $number, $min, $max );
		}
	}
