...
$wp_customize->add_control( new Yuma_Toggle_Switch_Custom_control( $wp_customize, 'sample_toggle_switch',
	array(
...
$wp_customize->add_setting( 'sample_slider_control',
	array(
		...
		'sanitize_callback' => 'yuma_sanitize_integer'
	)
);
$wp_customize->add_control( new Yuma_Slider_Custom_Control( $wp_customize, 'sample_slider_control',
	array(
...
$wp_customize->add_setting( 'sample_sortable_repeater_control',
	array(
		'default' => '',
		'transport' => 'refresh',
		'sanitize_callback' => 'yuma_url_sanitization'
	)
);
$wp_customize->add_control( new Yuma_Sortable_Repeater_Custom_Control( $wp_customize, 'sample_sortable_repeater_control',
	array(
...
$wp_customize->add_control( new Yuma_Image_Radio_Button_Custom_Control( $wp_customize, 'sample_image_radio_button',
	array(
...
$wp_customize->add_control( new Yuma_Text_Radio_Button_Custom_Control( $wp_customize, 'sample_text_radio_button',
	array(
...
$wp_customize->add_control( new Yuma_Image_checkbox_Custom_Control( $wp_customize, 'sample_image_checkbox',
	array(
...
$sampleIconsList = array(
	'Behance' => __( '<i class="fa fa-behance"></i>', 'yuma' ),
	'Bitbucket' => __( '<i class="fa fa-bitbucket"></i>', 'yuma' ),
	'CodePen' => __( '<i class="fa fa-codepen"></i>', 'yuma' ),
	'DeviantArt' => __( '<i class="fa fa-deviantart"></i>', 'yuma' ),
	'Dribbble' => __( '<i class="fa fa-dribbble"></i>', 'yuma' ),
	'Etsy' => __( '<i class="fa fa-etsy"></i>', 'yuma' ),
	'Facebook' => __( '<i class="fa fa-facebook"></i>', 'yuma' ),
	'Flickr' => __( '<i class="fa fa-flickr"></i>', 'yuma' ),
	'Foursquare' => __( '<i class="fa fa-foursquare"></i>', 'yuma' ),
	'GitHub' => __( '<i class="fa fa-github"></i>', 'yuma' ),
);
...
$wp_customize->add_control( new Yuma_Single_Accordion_Custom_Control( $wp_customize, 'sample_single_accordion',
	array(
...
$wp_customize->add_control( new Yuma_Single_Accordion_Custom_Control( $wp_customize, 'another_sample_single_accordion',
	array(
...
$wp_customize->add_control( new Yuma_Simple_Notice_Custom_control( $wp_customize, 'sample_simple_notice',
	array(
...
To santize your controls data, use my `yuma_text_sanitization` function or any other function that can sanitize a simple string and also a series of comma delimited strings. It's worth noting that the multiselect dropdown will either save a single string or a series of comma delimited strings, depending on the number of entries selected in the dropdown.
...
$wp_customize->add_control( new Yuma_Dropdown_Select2_Custom_Control( $wp_customize, 'sample_dropdown_select2_control_single',
	array(
		'label' => __( 'Dropdown Select2 Control', 'yuma' ),
		'description' => esc_html__( 'Sample Dropdown Select2 custom control (Single Select)', 'yuma' ),
		'section' => 'sample_custom_controls_section',
		'input_attrs' => array(
			'placeholder' => __( 'Please select a state...', 'yuma' ),
			'multiselect' => false,
		),
		'choices' => array(
			'nsw' => __( 'New South Wales', 'yuma' ),
			'vic' => __( 'Victoria', 'yuma' ),
			'qld' => __( 'Queensland', 'yuma' ),
			'wa' => __( 'Western Australia', 'yuma' ),
			'sa' => __( 'South Australia', 'yuma' ),
			'tas' => __( 'Tasmania', 'yuma' ),
			'act' => __( 'Australian Capital Territory', 'yuma' ),
			'nt' => __( 'Northern Territory', 'yuma' ),
		)
	)
) );
...
$wp_customize->add_control( new Yuma_Dropdown_Select2_Custom_Control( $wp_customize, 'sample_dropdown_select2_control_multi',
	array(
		'label' => __( 'Dropdown Select2 Control', 'yuma' ),
		'description' => esc_html__( 'Sample Dropdown Select2 custom control (Multi-Select)', 'yuma' ),
		'section' => 'sample_custom_controls_section',
		'input_attrs' => array(
			'multiselect' => true,
		),
		'choices' => array(
			__( 'Antarctica', 'yuma' ) => array(
				'Antarctica/Casey' => __( 'Casey', 'yuma' ),
				'Antarctica/Davis' => __( 'Davis', 'yuma' ),
				'Antarctica/DumontDurville' => __( 'DumontDUrville', 'yuma' ),
				'Antarctica/Macquarie' => __( 'Macquarie', 'yuma' ),
				'Antarctica/Mawson' => __( 'Mawson', 'yuma' ),
				'Antarctica/McMurdo' => __( 'McMurdo', 'yuma' ),
				'Antarctica/Palmer' => __( 'Palmer', 'yuma' ),
				'Antarctica/Rothera' => __( 'Rothera', 'yuma' ),
				'Antarctica/Syowa' => __( 'Syowa', 'yuma' ),
				'Antarctica/Troll' => __( 'Troll', 'yuma' ),
				'Antarctica/Vostok' => __( 'Vostok', 'yuma' ),
			),
			__( 'Atlantic', 'yuma' ) => array(
				'Atlantic/Azores' => __( 'Azores', 'yuma' ),
				'Atlantic/Bermuda' => __( 'Bermuda', 'yuma' ),
				'Atlantic/Canary' => __( 'Canary', 'yuma' ),
				'Atlantic/Cape_Verde' => __( 'Cape Verde', 'yuma' ),
				'Atlantic/Faroe' => __( 'Faroe', 'yuma' ),
				'Atlantic/Madeira' => __( 'Madeira', 'yuma' ),
				'Atlantic/Reykjavik' => __( 'Reykjavik', 'yuma' ),
				'Atlantic/South_Georgia' => __( 'South Georgia', 'yuma' ),
				'Atlantic/Stanley' => __( 'Stanley', 'yuma' ),
				'Atlantic/St_Helena' => __( 'St Helena', 'yuma' ),
			),
			__( 'Australia', 'yuma' ) => array(
				'Australia/Adelaide' => __( 'Adelaide', 'yuma' ),
				'Australia/Brisbane' => __( 'Brisbane', 'yuma' ),
				'Australia/Broken_Hill' => __( 'Broken Hill', 'yuma' ),
				'Australia/Currie' => __( 'Currie', 'yuma' ),
				'Australia/Darwin' => __( 'Darwin', 'yuma' ),
				'Australia/Eucla' => __( 'Eucla', 'yuma' ),
				'Australia/Hobart' => __( 'Hobart', 'yuma' ),
				'Australia/Lindeman' => __( 'Lindeman', 'yuma' ),
				'Australia/Lord_Howe' => __( 'Lord Howe', 'yuma' ),
				'Australia/Melbourne' => __( 'Melbourne', 'yuma' ),
				'Australia/Perth' => __( 'Perth', 'yuma' ),
				'Australia/Sydney' => __( 'Sydney', 'yuma' ),
			)
		)
	)
) );
...
$wp_customize->add_control( new Yuma_Dropdown_Posts_Custom_Control( $wp_customize, 'sample_dropdown_posts_control',
	array(
		'label' => __( 'Dropdown Posts Control', 'yuma' ),
		'description' => esc_html__( 'Sample Dropdown Posts custom control description', 'yuma' ),
		'section' => 'sample_custom_controls_section',
		'input_attrs' => array(
			'posts_per_page' => -1,
			'orderby' => 'name',
...
$wp_customize->add_control( new Yuma_TinyMCE_Custom_control( $wp_customize, 'sample_tinymce_editor',
	array(
...
$wp_customize->add_control( new Yuma_Google_Font_Select_Custom_Control( $wp_customize, 'sample_google_font_select',
	array(
...
$wp_customize->add_control( new Yuma_Customize_Alpha_Color_Control( $wp_customize, 'sample_alpha_color_picker',
	array(
...
$wp_customize->add_control( new Yuma_Alpha_Color_Control( $wp_customize, 'sample_wpcolorpicker_alpha_color',
	array(
		'label' => __( 'Alpha Color Picker Control' ),
...
$wp_customize->add_control( new Yuma_Alpha_Color_Control( $wp_customize, 'sample_wpcolorpicker_alpha_color2',
	array(
		'label' => __( 'Alpha Color Picker Control' ),
		'description' => esc_html__( 'Sample color control with Alpha channel' ),
		'section' => 'sample_custom_controls_section',
...
$wp_customize->add_control( new Yuma_Pill_Checkbox_Custom_Control( $wp_customize, 'sample_pill_checkbox',
	array(
		'label' => __( 'Pill Checkbox Control', 'yuma' ),
		'description' => esc_html__( 'This is a sample Pill Checkbox Control', 'yuma' ),
		'section' => 'sample_custom_controls_section',
		'input_attrs' => array(
			'sortable' => false,
			'fullwidth' => false,
		...
		'choices' => array(
			'tiger' => __( 'Tiger', 'yuma' ),
			'lion' => __( 'Lion', 'yuma' ),
			'giraffe' => __( 'Giraffe', 'yuma'  ),
			'elephant' => __( 'Elephant', 'yuma'  ),
			'hippo' => __( 'Hippo', 'yuma'  ),
			'rhino' => __( 'Rhino', 'yuma'  ),
		)
	)
...
$wp_customize->add_control( new Yuma_Pill_Checkbox_Custom_Control( $wp_customize, 'sample_pill_checkbox2',
	array(
		'label' => __( 'Pill Checkbox Control', 'yuma' ),
		'description' => esc_html__( 'This is a sample Sortable Pill Checkbox Control', 'yuma' ),
		'section' => 'sample_custom_controls_section',
		'input_attrs' => array(
			'sortable' => true,
			'fullwidth' => false,
		...
		'choices' => array(
			'captainamerica' => __( 'Captain America', 'yuma' ),
			'ironman' => __( 'Iron Man', 'yuma' ),
			'captainmarvel' => __( 'Captain Marvel', 'yuma'  ),
			'msmarvel' => __( 'Ms. Marvel', 'yuma'  ),
			'Jessicajones' => __( 'Jessica Jones', 'yuma'  ),
			'squirrelgirl' => __( 'Squirrel Girl', 'yuma'  ),
			'blackwidow' => __( 'Black Widow', 'yuma'  ),
			'hulk' => __( 'Hulk', 'yuma'  ),
		)
	)
) );
...
$wp_customize->add_control( new Yuma_Pill_Checkbox_Custom_Control( $wp_customize, 'sample_pill_checkbox3',
	array(
		'label' => __( 'Pill Checkbox Control', 'yuma' ),
		'description' => esc_html__( 'This is a sample Sortable Fullwidth Pill Checkbox Control', 'yuma' ),
		'section' => 'sample_custom_controls_section',
		'input_attrs' => array(
			'sortable' => true,
			'fullwidth' => true,
		...
		'choices' => array(
			'date' => __( 'Date', 'yuma' ),
			'author' => __( 'Author', 'yuma' ),
			'categories' => __( 'Categories', 'yuma'  ),
			'tags' => __( 'Tags', 'yuma'  ),
			'comments' => __( 'Comments', 'yuma'  ),
		)
	)
) );
````
...
$wp_customize->add_section( new Yuma_Upsell_Section( $wp_customize, 'upsell_section',
	array(
		'title' => __( 'Premium Addons Available', 'yuma' ),
		'url' => 'https://yumathemes.com',
...
- Update yuma_hex_rgba_sanitization() to sanitize RBG and RGBa colors
...
= 1.0.13 =
- Don't enqueue the Font Awesome stylesheet within the Yuma_Single_Accordion_Custom_Control Control as it's not actually needed.
...
= 1.0.10 =
- Added ability to specify Palette colours in the new Yuma_Alpha_Color_Control Custom Control

= 1.0.9 =
- Added new Yuma_Alpha_Color_Control Custom Control which uses modified WPColorPicker script

= 1.0.8 =
- Renamed fontawesome stylsheet

= 1.0.7 =
- Update yuma_get_social_media() to store output as array rather than string to make it easier for filtering
- Added new filter (yuma_social_icons_list) for filtering social media icons list array
